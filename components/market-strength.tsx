...
export default function MarketStrength({initial}:{initial:StrengthSnapshot|null}){
 ...
 return <div className="strength-dashboard">
  <div className="strength-heading"><div><p className="sf-eyebrow">PREMIUM / MARKET DASHBOARD</p><h1>Industry &amp; theme strength</h1><p>Where leadership is holding. Where it’s changing.</p></div><span className="strength-private">RESEARCH PREVIEW</span></div>
