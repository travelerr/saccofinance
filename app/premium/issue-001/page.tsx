...
const issue=getPublishedWeeklyOutlooks().find(outlook=>outlook.id==='weekly-outlook-001');
export const metadata=pageMetadata(issue?.title||'Weekly Outlook',issue?.summary||'Sacco Premium research.','/premium/issue-001',true);
