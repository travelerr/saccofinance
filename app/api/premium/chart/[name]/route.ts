...
export async function GET(_request:Request,{params}:{params:Promise<{name:string}>}){
 ...
 const{name}=await params;if(!['zs-2026-09-16','rklb-daily-chart','now-2026-09-18','spcx-stage-analysis','spcx-setup','btc-2026-09-23','mstr-trade-plan-2026-09-23','mstr-trendspider-2026-09-23'].includes(name))return new Response(null,{status:404});
